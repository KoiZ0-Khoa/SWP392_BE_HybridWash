...
namespace HybridWash.Repositories.Migrations
{
    ...
    [Migration("20260821163055_AddIncidentReportImages3To5")]
    partial class AddIncidentReportImages3To5
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HybridWash.Entities.Models.Booking", b =>
                {
                    ...
                    b.Property<string>("IncidentImage3")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("IncidentImage4")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("IncidentImage5")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("HybridWash.Entities.Models.Customer", b =>
                {
                    ...
                    b.Property<DateTime?>("LastTierReviewedAt")
                        .HasColumnType("datetime");
            ...
            modelBuilder.Entity("HybridWash.Entities.Models.CustomerTierHistory", b =>
                {
                    b.Property<int>("TierHistoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("TierHistoryID");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TierHistoryId"));
                    ...
                    b.Property<decimal>("QualifyingSpend")
                        .HasColumnType("decimal(18, 2)");

                    b.Property<int>("QualifyingVisits")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HybridWash.Entities.Models.PointLedger", b =>
                {
                    ...
                    b.HasIndex(new[] { "TransactionType", "ExpireDate" }, "IX_PointLedger_TransactionType_ExpireDate");

                    b.HasIndex(new[] { "SourceTransactionId" }, "UX_PointLedger_ExpireSourceTransactionID")
                        .IsUnique()
            ...
            modelBuilder.Entity("HybridWash.Entities.Models.TierRule", b =>
                {
                    b.Property<int>("TierRuleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("TierRuleID");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TierRuleId"));
                    ...
                    b.ToTable("TierRules", (string)null);
            ...
            modelBuilder.Entity("HybridWash.Entities.Models.PointLedger", b =>
                {
                    ...
                    b.HasOne("HybridWash.Entities.Models.PointLedger", null)
                        .WithMany()
