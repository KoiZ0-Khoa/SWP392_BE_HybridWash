...
public class BookingImagesController : ControllerBase
{
    ...
    public BookingImagesController(IBookingImageService bookingImageService)
    {
    ...
    public async Task<IActionResult> GetIncidentImage(
        int bookingId,
        int imageNumber,
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            var image = await _bookingImageService.GetIncidentImageAsync(
                bookingId,
                imageNumber,
                requesterId,
                requesterRole,
